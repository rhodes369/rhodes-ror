...
class MaterialTypesTest < ActionDispatch::IntegrationTest
  ...
  def setup
    ...
    @mat_type_2 = FactoryGirl.create(:material_type, id: 2, title: 'granite')    

    2.times { FactoryGirl.create(:material, material_type_id: 1) }
    @mat_3 = FactoryGirl.create(:material, material_type_id: 2)      
  end 
