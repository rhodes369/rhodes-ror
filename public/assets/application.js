    ...
    return $('.filters .filterWrap').on({
      change: function(event) {
        var key, value, _ref,
          _this = this;
        this.filters = {};
        this.filters['mat_type_id'] = $('#matTypeId').val();
        this.filters['mat_finish_id'] = $('#matFinishId').val();
        this.filters['mat_app_id'] = $('#matAppId').val();
        this.searchResults = $('#searchResults');
        this.searchResults.fadeOut('medium');
        this.url = "/materials/search";
        console.log("filter changes detected");
        console.log("@filters: " + this.filters.inspect + " @url: " + this.url.inspect + " ");
        _ref = this.filters;
        for (key in _ref) {
          value = _ref[key];
        ...
        return $.ajax({
          ...
          success: function(data) {
            ...
            return _this.searchResults.fadeIn(3000);
          },
          error: function(data) {
...
(function() {
  ...
  $(document).ready(function() {
    return $('#globalAlert').click(function() {
      $(this).remove();
      return setTimeout(removeAlert, 7000);
    });
  });
  ...
  ({
    removeAlert: function() {
      var _this = this;
      return $('#globalAlert').fadeOut('500', function() {
        return $(_this).remove();
      });
    }
  });
...
(function() {
  ...
  $(document).ready(function() {
    var totalWidth;
    totalWidth = 0;
    $(".gallery-thumbs form").children().each(function() {
    ...
    return $(".next").click(function() {
      var currentPos, nextScroll, remainingScroll, scrollAmount;
      ...
      if (remainingScroll < nextScroll) nextScroll = remainingScroll;
