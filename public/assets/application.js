...
(function() {
  ...
  $(document).ready(function() {
    ...
    return $(".items").css("width", parseInt(totalWidth) + "px");
  });

}).call(this);
(function() {

  App.prependLeftSideBarDashes = function() {
    if ($("#content-left").length > 0) {
      return $("#content-left ul ul li a").prepend("&#8211; ");
    }
  };
...
(function() {
  ...
  SearchMaterials = (function() {
    ...
    function SearchMaterials() {
      this.searchResultsDiv = $('#materialSearchResults');
      this.spinner = $('#spinner');
      this.setFilterListener();
      this.filters = this.getFilters();
      this.processSearch(this.filters);
    }

    SearchMaterials.prototype.setFilterListener = function() {
      var _this = this;
      return $('.filters .filterWrap').on({
        change: function(event) {
          log("search filter changed");
          _this.filters = _this.getFilters();
          _this.processSearch(_this.filters);
          return $('#resultsHeader').show();
        }
      });
    };

    SearchMaterials.prototype.getFilters = function() {
      var matAppId, matFinishId, matTypeId;
      this.filters = {};
      matTypeId = $('#matTypeId').val();
      matFinishId = $('#matFinishId').val();
      matAppId = $('#matAppId').val();
      if (matTypeId !== '') this.filters['mat_type_id'] = matTypeId;
      if (matFinishId !== '') this.filters['mat_finish_id'] = matFinishId;
      if (matAppId !== '') this.filters['mat_app_id'] = matAppId;
      return this.filters;
    };

    SearchMaterials.prototype.processSearch = function(filters) {
      var _this = this;
      this.filters = filters;
      this.spinner.show();
      this.searchResultsDiv.fadeOut('medium');
      this.url = "/materials/search";
      return $.ajax({
        url: this.url,
        dataType: 'json',
        type: 'PUT',
        ...
        success: function(data) {
          ...
          _this.spinner.hide();
          return _this.searchResultsDiv.fadeIn(999);
        },
        error: function(data) {
  ...
  $(document).ready(function() {
    ...
    if ($('#materialSearchResults').length > 0) {
      return search = new SearchMaterials();
    }
  });
...
(function() {
  ...
  $(document).ready(function() {
    ...
    return $("body").filter(function() {
      return this.className.match(/^Antique/) != null;
    }).each(function() {
      $("ul#antiques").css("display", "block");
      return $("ul#newly").css("display", "none");
    });
  });
...
function writeText(txt) {
  document.getElementById("finish").innerHTML=txt;
}
;
$(function(){
